...
app.config["MONGO_URI"] = "YOUR MONGODB STRING"
mongo = PyMongo(app)
bcrypt = Bcrypt(app)
...
ADMIN_USERNAME = 'admin'  # CHANGE ADMIN USERNAME AND PASSWARD ACCORDING TO YOU
...
def view_reservations():
    ...
    # Collect detailed reservation information for each reservation
    detailed_reservations = []
    for reservation in reservations:
        # Get user information associated with the reservation
        user = mongo.db.users.find_one({'_id': ObjectId(reservation['user_id'])})
        user_name = user['name'] if user else 'Unknown User'

        # Get book information associated with the reservation
    ...
    # Render the reservations page with all reservations
...
def user_profile(user_id):
    print(f"Accessing profile for user_id: {user_id}")  # Debug line
